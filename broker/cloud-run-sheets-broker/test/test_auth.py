...
class AuthTests(unittest.TestCase):
    ...
    def test_verify_claims_accepts_additional_cli_audience(self) -> None:
        config = AuthConfig(
            accepted_issuers=("https://accounts.google.com",),
            audience="chrome-client-id",
            accepted_audiences=("chrome-client-id", "32555940559.apps.googleusercontent.com"),
            hosted_domain="day1company.co.kr",
        )
